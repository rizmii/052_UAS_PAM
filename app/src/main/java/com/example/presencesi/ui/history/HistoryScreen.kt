...
object DetailDestination : DestinasiNavigasi {
    ...
    override val titleRes = "History Presensi"
    const val presensiId = "itemId"
    val routeWithArgs = "$route/{$presensiId}"
}
...
fun HistoryScreen(
    ...
    Scaffold(
        topBar = {
            ...
            FloatingActionButton(
                onClick = { navigateToEditItem(uiState.value.addEvent.NIM) },
...
private fun ItemDetailsBody(
    ...
    Column(
        ...
        ItemDetails(
            presensi  = detailUIState.addEvent.toPresensi(), modifier = Modifier.fillMaxWidth()
        )
...
@Composable
fun ItemDetails(
    presensi: Presensi, modifier: Modifier = Modifier
) {
    Card(
        ...
        Column(
            ...
            ItemDetailsRow(
                ...
                itemDetail = presensi.keterangan,
                modifier = Modifier.padding(
                    horizontal = 12.dp
                )
            )
